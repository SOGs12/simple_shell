...
/**
 * _which - fleshes out the command by appending it
 * to a matching PATH directory
 * @str: first command user typed into a shell
 * (e.g. "ls" if a user typed "ls -l")
 * @env: environmental variable
 * Return: a copy of fleshed out the command
 * (e.g. "/bin/ls" if originally "ls")
 */
